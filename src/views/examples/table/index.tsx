...
// Types Imports
import type { TableHeadCell, Row } from '@components/mui/table/types'
...
const headCells: TableHeadCell<User & Row>[] = [
    ...
    <Grid container rowGap={4}>
      ...
      <Grid size={{ xs: 12 }}>
        <Card>
          ...
          <CardContent>
            <Grid container spacing={6}>
              <Grid size={{ xs: 12, sm: 4 }}>
                <EnumSelect items={[]} value={''} label='Status' onChange={() => {}} />
              </Grid>
              <Grid size={{ xs: 12, sm: 4 }}>
                <EnumSelect items={[]} value={''} label='Status' onChange={() => {}} />
              </Grid>
          ...
          <MuiTable sortBy='id' total={2} headCells={headCells} rows={users} onPageChange={handlePageChange} />
        </Card>
      </Grid>
      <Grid size={{ xs: 12 }}>
      ...
      <Grid size={{ xs: 12 }}>
        <Card>
          ...
          <MuiTable sortBy='id' total={0} headCells={headCells} rows={[]} onPageChange={handlePageChange} />
        </Card>
      </Grid>
      <Grid size={{ xs: 12 }}>
